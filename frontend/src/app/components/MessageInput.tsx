      ...
      >
        ...
        <div className='flex items-center gap-2 '>
          <label className='cursor-pointer bg-gray-700 hover:bg-gray-600 rounded-lg px-3 py-2 transition-colors'>
            ...
            <input
              type='text'
              className='flex-1 bg-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none'
          ...
          <button
            ...
            className='bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed text-white'
          >
            {
